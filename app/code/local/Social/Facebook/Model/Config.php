 ...
 */
class Social_Facebook_Model_Config
{
    ...
    {
    	return array('email,user_location,user_likes,publish_stream,user_events,read_stream,offline_access,create_event,manage_pages,user_birthday');
    }
