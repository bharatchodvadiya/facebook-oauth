 ...
 */
class Social_Facebook_Model_Client extends Social_Facebook_Model_Facebook
{
	...
	public function __construct()
	{
		...
		if(count($args)<2) {
			trigger_error('Missing arguments for Social_Facebook_Model_Client::__construct()',E_USER_ERROR);
		}
